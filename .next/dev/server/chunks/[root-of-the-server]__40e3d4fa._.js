...
const ensureCallsTable = async ()=>{
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]) throw new Error("Database not configured");
    try {
        // Check if table exists
        const tableExists = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      SELECT EXISTS (
    ...
    `;
      ...
      `;
            // Create indexes
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX idx_calls_agent ON calls(agent_id)`;
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX idx_calls_conversation ON calls(conversation_id)`;
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX idx_calls_status ON calls(status)`;
...
async function GET(request) {
    ...
    try {
        ...
        let query;
        if (conversationId) {
            query = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
        SELECT * FROM calls 
...
async function POST(request) {
    ...
    try {
        ...
        const { contact_name, phone_number, conversation_id, scheduled_at, call_type, notes } = body;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__40e3d4fa._.js.map