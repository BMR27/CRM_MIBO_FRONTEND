        ...
        "useContacts.useCallback[fetchContacts]": async ()=>{
            try {
                ...
                const data = await res.json().catch({
                    "useContacts.useCallback[fetchContacts]": ()=>null
        ...
        try {
            ...
            if (!res.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                    title: "Error",
                    description: data?.error || "No se pudo actualizar el contacto",
                    variant: "destructive"
                });
                return;
            }
    ...
    const handleConfirmDelete = async ()=>{
        ...
        try {
            ...
            if (!res.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                    title: "Error",
                    description: data?.error || "No se pudo eliminar el contacto",
                    variant: "destructive"
                });
                return;
            }
...
_s(ContactsList, "alGmpp9BGwFnfs2pRuyE0TbkAxQ=", false, function() {
    return [
    ...
    const handleChatContact = async (contact)=>{
        ...
        try {
            ...
            if (!res.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                    title: "Error",
                    description: data?.error || "No se pudo abrir la conversación",
                    variant: "destructive"
                });
                return;
            }
            ...
            if (!conversationId) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                    title: "Error",
                    description: "No se pudo crear/obtener la conversación",
                    variant: "destructive"
                });
                return;
            }
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                title: "Error",
                description: e instanceof Error ? e.message : "No se pudo abrir la conversación",
                variant: "destructive"
            });
        }
    };
    ...
    const handleCreateContact = async ()=>{
        try {
            ...
            if (!res.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                    title: "Error",
                    description: data?.error || "No se pudo crear el contacto",
                    variant: "destructive"
                });
                return;
            }
...
//# sourceMappingURL=_b876a9ae._.js.map