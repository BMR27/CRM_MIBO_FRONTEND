...
function formatPhoneForDisplay(raw) {
    ...
    const ten = (n)=>`${n.slice(0, 3)} ${n.slice(3, 6)} ${n.slice(6)}`;
...
function formatContactDisplayName(rawName, channel) {
...
function getContactAvatarText(displayName, channel) {
        ...
        "useUserRole.useEffect": ()=>{
            const fetchUserInfo = {
                "useUserRole.useEffect.fetchUserInfo": async ()=>{
                    try {
                        const backendUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || "https://crmbackend-production-4e4d.up.railway.app";
...
function InboxSidebar({ user }) {
    ...
    const { isAdminOrSupervisor } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$user$2d$role$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserRole"])();
...
_s(InboxSidebar, "PWbshskykY+I9DAh2Wyhe6prePE=", false, function() {
    return [
...
//# sourceMappingURL=_1663b9c3._.js.map