...
import { MessageSquare, Lock, Mail, User, Building2 } from "lucide-react"
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-primary/80 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-primary-foreground">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4 text-balance">Crea tu espacio de trabajo</h1>
            <p className="text-lg text-primary-foreground/90 leading-relaxed text-pretty">
              Registra tu empresa y obtén tu propio CRM aislado para gestionar conversaciones, contactos y pedidos.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-2 text-center lg:text-left">
              <h2 className="text-3xl font-bold tracking-tight">Registra tu compañía</h2>
              <p className="text-muted-foreground">Crea tu espacio de trabajo y tu cuenta de administrador</p>
            </div>
